# This is a stegonography tool, I am building a GUI that combines this with a couple other products im developing
# therefor this isnt a final version but its the bulk of the code that will get swamped up in the massive gui program.
