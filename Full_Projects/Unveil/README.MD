...
- _main_.py: This file hosts the GUI- it calls on the other two files.
- Encryptor.py: Hosts the encryption, essentially a module, class can be called from main and individual functions used from there.
- Decryptor.py: Hosts the decryption, takes a token/ credentials and allows the decryption of the users data they initially inputted.
