...
Invoke-AppDeployToolkit will need ran and then it will compile to an exe which can be ran from an intune app/ uploaded to company portal or through auto rollout to devices.
